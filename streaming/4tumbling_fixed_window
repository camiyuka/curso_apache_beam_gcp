...
pipeline_options = {
    ...
    'template_location': 'gs://apache_dataflow-udemy/template/streaming_tumpling_window',
...
serviceAccount = r"C:\\Users\\camila yatabe\Downloads\dataflow-apache-beam-415812-f900aff91ba8.json"
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]= serviceAccount

subscription = 'projects/dataflow-apache-beam-415812/subscriptions/meus_voos-sub'
saida = 'projects/dataflow-apache-beam-415812/topics/saida'

class separar_linhas(beam.DoFn):
  def process(self,record):
    return [record.decode("utf-8").split(',')] # decode para ler 
...
tabela_atrasos = (
    ...
    | 'Converting to byte String' >> beam.Map(lambda row: (''.join(str(row)).encode('utf-8')) ) # para mandar para o pubsub tem que dar o encode
